...
public class FragmentStudy extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
         listView = Objects.requireNonNull(getActivity()).findViewById(R.id.study_list);
        myapplication=(Myapplication) getActivity().getApplication();
        swipeRefreshLayout=getActivity().findViewById(R.id.swipeLayout2);
    ...
    private void doData(boolean isDo){
        ...
        builder.add("style", "学习");
        builder.add("token", JSON.toJSONString(token));
